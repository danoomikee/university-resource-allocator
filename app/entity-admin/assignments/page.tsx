...
export default function EntityAdminAssignmentsPage() {
  ...
  useEffect(() => {
    ...
    const relevantAssignments = allAssignments.filter((a) => {
      ...
      return entity?.parentEntityId === user.assignedEntityId
    })

    const relevantSubEntities = allEntities.filter((e) => e.parentEntityId === user.assignedEntityId)
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Sub-Entity Assignments</h1>
          <p className="text-muted-foreground">Assign users to manage your sub-entities</p>
        </div>
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>Create a new assignment with auto-generated credentials</DialogDescription>
            </DialogHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Users assigned to manage your sub-entities</CardDescription>
        </CardHeader>
        <CardContent>
              ...
              <TableBody>
                {filteredAssignments.length === 0 ? (
                  ...
                  filteredAssignments.map((assignment) => {
                    ...
                    const assignedEntity = subEntities.find((e) => e.id === assignment.entityId)
                    return (
